...
//TERCERA OPCION - LA MAS SENCILLA
...
//PRIMERA OPCION
//   var todosIguales = array.every(elemento => {
...
function mesesDelAño(array) {
   ...
   // Tu código:
   var nuevoArrayDeMeses = [];
   array.forEach(mes => {
      if (mes === "Enero") {
         nuevoArrayDeMeses.push (mes) 
      } else if (mes === "Marzo") {
         nuevoArrayDeMeses.push (mes)
   ...
   if (nuevoArrayDeMeses.length === 3) {
      return nuevoArrayDeMeses
   } else {
...
function breakStatement(num) {
   ...
   //OPCION SIN BREAK:
   //var nuevoArrayDeNumeros = [];
   //for(var i = 0; i < 10; i++) {
   //   num = num + 2;
   //   nuevoArrayDeNumeros.push(num);
   //   if (num === i) {
   //      return "Se interrumpió la ejecución"
   //   }
   //}
   //return nuevoArrayDeNumeros
   ...
   for (var i = 0; i < 10; i++) {
      ...
      if (nuevoArrayDeNumeros.length === num) {
         break;
      }
   }
   return nuevoArrayDeNumeros
