...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   var multiplicarNumeroDesconocidoPorCinco = objetoMisterioso.numeroMisterioso * 5;
...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   var tieneEmail = objetoUsuario.hasOwnProperty("email") && objetoUsuario.email !== null;
   return tieneEmail
}
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   for (var i = 0; i < objetoUsuario.posts.length; i++) {
      sumarLikesDeUsuario = sumarLikesDeUsuario + objetoUsuario.posts[i].likes
   }
